...
class nextOfferForm extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
    ...
    const info = {
      ...
      await axios
        ...
        .then(response => {
          ...
          alert(
            "Congratulations! Your offer has been created successfully. Happy learning!"
          );
          event.preventDefault();
          window.location = `/requests/${this.state.userID}/${this.state.course}`;
           } )
